...
public class logica_ventana implements ActionListener, ListSelectionListener, ItemListener {
    ...
    public logica_ventana(ventana delegado) {
        ...
        // Aqui se ecnuentran los eventos que existen
        ...
        this.delegado.menuItemEliminar.addActionListener(this);
        this.delegado.menuItemModificar.addActionListener(this);

        // AQui esta agregado el ListSelectionListener para cargar los datos al seleccionar
        ...
        // Aqui estan los atajos de teclado
        this.delegado.addKeyListener(new KeyListener() {
            @Override
        ...
        this.delegado.setFocusable(true);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == delegado.btn_add) {
            if ((!nombres.equals("")) && (!telefono.equals("")) && (!email.equals(""))) {
                ...
                JOptionPane.showMessageDialog(delegado, "Deben estar llenados todos lod campos!!!");
            }
            ...
            modificarContacto();  // Implementado
    ...
    private void modificarContacto() {
        ...
        if (row != -1) {
            int modelRow = delegado.tbl_contactos.convertRowIndexToModel(row);
            if ((!nombres.equals("")) && (!telefono.equals("")) && (!email.equals(""))) {
                if ((!categoria.equals("Seleccione una Categoria")) && (!categoria.equals(""))) {
